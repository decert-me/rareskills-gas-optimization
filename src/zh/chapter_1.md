...
有gas-$种高效的方法可以确定一个数是否为质数，但这种需求非常罕见，为此而分配空间会降低本文的价值。同样，在我们的[Tornado Cash 教程](https://www.rareskills.io/post/how-does-tornado-cash-work)中，我们提出了代码库可以更高效的方式，但在这里包含这种处理对读者没有好处，因为它过于特定于应用程序。
