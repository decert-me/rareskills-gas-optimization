...
- [3. 通过优化 IPFS 哈希以获得更多的零（或使用 --no-cbor-metadata 编译器选项）来减小部署大小](#3-通过优化-ipfs-哈希以获得更多的零或使用--no-cbor-metadata编译器选项可以减小部署大小)
...
- [8. 自定义错误（通常）比 require 语句更小](#8-自定义错误通常比-require语句更小)
