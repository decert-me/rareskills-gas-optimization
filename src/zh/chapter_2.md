...
- [5. 在选择内部函数和修饰器之间时要了解权衡](#5-understand-the-trade-offs-when-choosing-between-internal-functions-and-modifiers)
- [6. 在部署不经常调用的非常相似的智能合约时，可以使用克隆或元代理](#6-use-clones-or-metaproxies-when-deploying-very-similar-smart-contracts-that-are-not-called-frequently)
- [7. 管理员函数可以接受支付](#7-admin-functions-can-be-payable)
- [8. 自定义错误（通常）比require语句更小](#8-custom-errors-are-usually-smaller-than-require-statements)
